...
<?php
    ...
    echo "<tr>
        <td align='center'><input type='checkbox' name='item[]' NIPD='item[]' value='$nipd'></td>
        <td>".$daftar['bulan']."</td>
        <td>".$daftar['total']."</td>
...
<?php
    ...
    echo "<tr>
        ...
        <td>".$daftar['sisa']."</td>
        <td>".$daftar['keterangan']."</td>
        <td><a href = 'pembayaranAwalTahun.php?kode=".$daftar['NIPD']."'>Bayar</a></td>
      </tr>";
  }
?>
...
<?php
    ...
    echo "<tr>
        ...
        <td>".$daftar['sisa']."</td>
        <td>".$daftar['keterangan']."</td>
        <td><a href = 'pembayaranPrakerin.php?kode=".$daftar['NIPD']."'>Bayar</a></td>
      </tr>";
  }
?>
</table>
