...
<body>
     ...
     <aside>
          <div id="sidebar"  class="nav-collapse ">
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="tampil_DaftarUlang.php" >
  ...
  <a class="logout" href="tampil_DaftarUlang.php">Clear</a>
...
<?php
  ...
  $query = mysql_query("select peserta_didik.NIPD, peserta_didik.pd_nama, peserta_didik_kelas.rombel_id, peserta_didik.pd_jenis_kelamin from peserta_didik, peserta_didik_kelas 
  ...
  while ($daftar = mysql_fetch_array($query)) {
    echo "<tr>
        ...
        <td><a href = 'daftarulang.php?kode=".$daftar['NIPD']."'>Bayar</a></td>
      </tr>";
  }
?>
  </tbody>
