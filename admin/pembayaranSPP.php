     ...
     <aside>
      ...
      <section id="main-content">
                  <section class="wrapper">
                    <h3 align="center"><b> PEMBAYARAN SPP </b></h3>
                       <?php
        include "koneksi.php";

        $NIPD = $_GET['kode'];
        $query = mysql_query ("select p.NIPD, p.pd_nama, pd.rombel_id, d.bulan from peserta_didik p, peserta_didik_kelas pd, tunggakan t, 
                              detail_tunggakan d where p.NIPD=pd.NIPD AND p.NIPD=t.NIPD AND 
                              t.tunggakan_id=d.tunggakan_id AND p.NIPD = '$NIPD'");
        $array = mysql_fetch_array($query);

        
      ?>
      &nbsp;
      <form action="prosesSPP.php" method="POST">
              <table align="center" width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
                  ...
                  <tr>
                      <td>Keterangan</td>
                      <td>:</td>
                      <td><input type="text" name="keterangan" value="Lunas" readonly></td>
                  </tr>
                  <tr>
                      <td>Tahun Ajaran</td>
                      <td>:</td>
                              ...
                              <option disabled="true" selected="">Pilih Data</option>
                                  <?php
                                    ...
                                    while($data = mysql_fetch_array($select)){
                                      echo "
                                          <option value=".$data['tahun_ajaran_nama'].">".$data['tahun_ajaran_nama']."</option>" ;
                                      }
                                    ?>
                          </select>
                      </td>
                  ...
                  <tr>
                      <td colspan="3" align="center"><input type="submit" name="submit" value="Bayar" onclick="this.form.target='_blank';return true;">
