     ...
     <aside>
      ...
      <section id="main-content">
                  <section class="wrapper">
                    <h3 align="center"><b> PEMBAYARAN PRAKERIN </b></h3>
                       <?php
        include "koneksi.php";

        $NIPD = $_GET['kode'];
        $query = mysql_query ("select p.NIPD, p.pd_nama, pd.rombel_id, d.bulan, d.total, d.sisa, d.keterangan from peserta_didik p, 
                              peserta_didik_kelas pd, tunggakan t, 
                              detail_tunggakan d, kategori k where p.NIPD=pd.NIPD AND p.NIPD=t.NIPD AND 
                              t.tunggakan_id=d.tunggakan_id AND k.kategori_id=t.kategori_id AND p.NIPD = '$NIPD' AND 
                              k.kategori_nama='PRAKERIN'");
        $array = mysql_fetch_array($query);
      ?>
      &nbsp;
      <form action="prosesPrakerin.php" method="POST">
              <table align="center" width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
                  ...
                  <tr>
                      <td>Nama</td>
                      <td>:</td>
                      <td><input type="text" name="nama" value="<?php echo   $array['pd_nama']; ?>" readonly></td>
                  </tr>
                  <tr>
                      <td>Kelas</td>
                      <td>:</td>
                      <td><input type="text" name="kelas" value="<?php echo   $array['rombel_id']; ?>" readonly></td>
                  </tr>
                  <tr>
                      <td>Total</td>
                      <td>:</td>
                      <td><input type="text" name="total" value="<?php echo   $array['total']; ?>" readonly></td>
                  </tr>
                  <tr>
                      <td>Sisa</td>
                      <td>:</td>
                      <td><input type="text" name="sisa" value="<?php echo   $array['sisa']; ?>" readonly></td>
                  </tr>
                  <tr>
                      <td>Jumlah Uang</td>
                      <td>:</td>
