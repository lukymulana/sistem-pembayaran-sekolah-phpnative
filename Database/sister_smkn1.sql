...
--
-- Host: localhost
-- Generation Time: Feb 22, 2016 at 01:15 
...
CREATE TABLE IF NOT EXISTS `detail_tunggakan` (
...
('', 'TG-14', 500000, 0, 'Lunas'),
('', 'TG-13', 2100000, 0, 'Lunas'),
...
CREATE TABLE IF NOT EXISTS `lapor_diri` (
...
('LD-1', '2016-02-22', '11321589', 'Naik', '1516');
...
CREATE TABLE IF NOT EXISTS `peserta_didik_kelas` (
  `NIPD` char(8) NOT NULL,
  `rombel_id` char(7) NOT NULL,
  `tahun_ajaran_id` char(4) NOT NULL,
  KEY `fk_pd_kelas_rombel` (`NIPD`),
...
CREATE TABLE IF NOT EXISTS `program_keahlian` (
  ...
  PRIMARY KEY (`program_keahlian_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `rombel` (
  ...
  KEY `paket_keahlian_id` (`paket_keahlian_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('TR-2', 'TG-14', 500000, '2016-02-22', 'admin'),
('TR-1', 'TG-13', 2100000, '2016-02-22', 'admin');
